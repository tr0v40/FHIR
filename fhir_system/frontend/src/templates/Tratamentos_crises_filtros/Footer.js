        ...
        <div className="row">
          ...
          <div className="col-12 col-md-4 mb-4">
            ...
            <div className="list-unstyled">
              <a href="https://www.instagram.com/telix.inf.br/" target="_blank" className="social-btn mx-2"><FaInstagram size={24} /></a>
              <a href="https://www.facebook.com/people/Telix-contexto-na-sa%C3%BAde/100089318347896/" target="_blank" className="social-btn mx-2"><FaFacebookF size={24} /></a>
              <a href="https://www.linkedin.com/company/telix-canais-de-not%C3%ADcias" target="_blank" className="social-btn mx-2"><FaLinkedinIn size={24} /></a>
              <a href="https://www.youtube.com/@TelixSaude" target="_blank" className="social-btn mx-2"><FaYoutube size={24} /></a>
            </div>
          </div>
