...
class DetalhesTratamentoResumo(models.Model):
    ...
    nome = models.CharField(max_length=200)
    descricao = models.TextField()
    categoria = models.CharField(max_length=100, blank=True, null=True)  # Adicionado de Tratamentos
    evidencia_clinica = models.TextField(blank=True, null=True)  # Adicionado de Tratamentos
    principio_ativo = models.CharField(max_length=200)
    fabricante = models.CharField(max_length=200)
    avaliacao = models.DecimalField(max_digits=3, decimal_places=2, blank=True, null=True)  # Adicionado
    eficacia_min = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)  # Adicionado
    eficacia_max = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)  # Adicionado
    prazo_efeito_min = models.CharField(max_length=50, blank=True, null=True)  # Adicionado
    prazo_efeito_max = models.CharField(max_length=50, blank=True, null=True)  # Adicionado
